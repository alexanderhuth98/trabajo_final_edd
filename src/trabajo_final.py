...
class Paciente:
    ...
    print(paciente1.mostrar_historial_paciente())
    ...
    paciente1.agregar_enfermedad('diarrea','pastilla de carbon')
    paciente1.agregar_enfermedad('gripe' , 'acemuk')
    ...
    def __init__(self , nombres_paciente , apellidos_paciente , edad , dni , telefono_paciente , domicilio_paciente , localidad_paciente , prepaga):
        ...
        fecha_alta = datetime.datetime.now(pytz.timezone('America/Argentina/Buenos_Aires')).strftime('%d/%m/%Y %H:%M:%S')
...
# def busqueda_enfermedad_recurrente(historial, clave, resultado=None):
#     """
...
#     return busqueda_enfermedad_recurrente(resto_historial, clave, resultado)




# def mostrar_busqueda_recurrente(resultado, clave):
#     """
#     Muestra los resultados de la búsqueda de manera legible.

#     Args:
#         resultado (dict): Resultado devuelto por la función busqueda_enfermedad_recurrente.
#         clave (str): Clave de búsqueda proporcionada (enfermedad o medicamento).

#     Returns:
#         str: Cadena formateada con los detalles de la búsqueda.
#     """
#     if resultado["total_apariciones"] == 0:
#         return f"No se encontraron coincidencias para '{clave}'."
    
#     salida = [f"Resultados de la búsqueda para '{clave}':"]
#     salida.append(f"Total de apariciones: {resultado['total_apariciones']}")
    
#     for detalle in resultado["detalles"]:
#         salida.append(f"Enfermedad: {detalle['enfermedad']} - Medicamento: {detalle['medicamento']}")
